    ...
    TEMPLATE_STR = '''
        <div class="row">
            {% if pyview.settingsInstance.realityCaptureSettings.settingsDefaultModelSets.default_models | length != 0 %}
                ...
                <div class="col-md-2" style="border-top:1px solid gray;padding-top:10px;padding-bottom:15px;">
                    <button class="btn btn-success btnfw" style="margin-right:5px" onclick='pyview.parent.subject.create_models_from_set($("#set_name").val());'> Create Models </button>
                </div>
            {% else %}
        ...
        <div class="row">    
            ...
            <div class="col-md-1 h5" style="text-align:center;font-weight:bold;width:12.5%">Reconstruction Quality</div>
            <div class="col-md-1 h5" style="text-align:center;font-weight:bold;width:12.5%">Export Quality</div>
            <div class="col-md-1 h5" style="text-align:center;font-weight:bold;width:12.5%">Mesh from</div>
            ...
            <div class="col-md-2 h5" style="text-align:center;font-weight:bold;width:20.833%">File</div>
        ...
        <div class="row" style="margin-top:10px">    
            ...
            <div class="col-md-1" style="text-align:center;width:12.5%">
            ...
            <div class="col-md-2" style="text-align:center;width:20.833%"></div>
...
class ModelFileItemView(PyHtmlView):
    ...
    TEMPLATE_STR = '''
        <div class="col-md-1" style="text-align:center"> {{pyview.subject.filetype}}  </div>
        <div class="col-md-1" style="text-align:center;width:12.5%"> {{pyview.subject.reconstruction_quality}} </div>
        <div class="col-md-1" style="text-align:center;width:12.5%"> {{pyview.subject.quality}} </div>
        <div class="col-md-1" style="text-align:center;width:12.5%"> {{pyview.subject.create_mesh_from}} </div>
        <div class="col-md-1" style="text-align:center"> {{pyview.subject.create_textures}} </div>
        <div class="col-md-1" style="text-align:center"> {{pyview.subject.lit}} </div>
        <div class="col-md-2" style="text-align:center;width:20.833%">
        ...
        {% if  pyview.parent.parent.settingsInstance.settingsDropbox.refresh_token != "" and pyview.subject.parentShot.dropboxPublicFolder.status != "new" %}
            ...
            <div class="col-md-1" style="text-align:center">
                {% if pyview.subject.is_shared == True %}
