            ...
            <div class="list-group mb-5 shadow">
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-2" style="text-align:center"> 
                            <input class="form-control" style="width:100%;text-align:center"  id="startup_delay_{{pyview.uid}}" value={{pyview.subject.startup_delay}} onchange='pyview.subject.set_startup_delay($("#startup_delay_{{pyview.uid}}").val())' type="number" min="2" max="10" />
                        </div>
                    </div>
                </div>
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-2" style="text-align:center"> 
                            <input class="form-control" style="width:100%;text-align:center" id="image_delay_{{pyview.uid}}" value={{pyview.subject.image_delay}} onchange='pyview.subject.set_image_delay($("#image_delay_{{pyview.uid}}").val())' type="number"  min="0" max="10"/>
                        </div>
                    </div>
                </div>
                <div class="list-group-item">
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-2" style="text-align:center">
                            <div class="custom-control custom-switch">
                               <input  class="form-control" style="width:100%;text-align:center" id="light_image1_{{pyview.uid}}" value="{{pyview.subject.image1.light}}" onchange='pyview.subject.image1._set_light($("#light_image1_{{pyview.uid}}").val())' type="number"/>
                                <span class="custom-control-label"></span>
                            </div>
                        </div>
                        <div class="col-md-2" style="text-align:center">
                            <div class="custom-control custom-switch">
                               <input  class="form-control" style="width:100%;text-align:center" id="light_image2_{{pyview.uid}}" value="{{pyview.subject.image2.light}}" onchange='pyview.subject.image2._set_light($("#light_image2_{{pyview.uid}}").val())' type="number"/>
                                <span class="custom-control-label"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="list-group-item">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-2" style="text-align:center">
                            <div class="custom-control custom-switch">
                                <input class="form-control" style="width:100%;text-align:center" id="offset_image1_{{pyview.uid}}" value="{{pyview.subject.image1.offset}}" onchange='pyview.subject.image1._set_offset($("#offset_image1_{{pyview.uid}}").val())' type="number"/>
                                <span class="custom-control-label"></span>
                            </div>
                        </div>
                        <div class="col-md-2" style="text-align:center">
                            <div class="custom-control custom-switch">
                                <input class="form-control" style="width:100%;text-align:center" id="offset_image2_{{pyview.uid}}" value="{{pyview.subject.image2.offset}}" onchange='pyview.subject.image2._set_offset($("#offset_image2_{{pyview.uid}}").val())' type="number"/>
                                <span class="custom-control-label"></span>
                            </div>
                        </div>
                    </div>
