...
class TaskShutterAdjustTopView(PyHtmlView):
    TEMPLATE_STR = '''
        <div class="col-md-2 topMenuItem">
            <p id="ssa_value" style="line-height: 15px;margin: 0px;margin-top:5px;text-align: center;">Shutter adjust ({{pyview.subject.shutter_speed_adjustment}}%, ~{{pyview.subject.average_shutter_speed}}ms )</p>
