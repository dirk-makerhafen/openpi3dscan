...
def get_cefpython3_datas():
    ...
    for filename in os.listdir(CEFPYTHON3_DIR):
        ...
        if extension in \
            ...
            if filename in ["icudtl.dat", "natives_blob.bin", "snapshot_blob.bin", "v8_context_snapshot.bin"]:
                ret.append((os.path.join(CEFPYTHON3_DIR, filename), os.path.join(cefdatadir, "cefpython3")))
