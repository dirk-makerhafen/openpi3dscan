class Light:
    ...
    def _adjust(self, values):
        ...
        result = self.device.api_request("/light/adjust/%s" % values)
    ...
    def _set(self, value):
        self.device.wait_locked()
        result = self.device.api_request("/light/set/%s" % value)
    ...
    def _sequence(self,sequence):
        ...
        self.device.lock(6)
        result = self.device.api_request("/light/sequence/%s" % sequence)
